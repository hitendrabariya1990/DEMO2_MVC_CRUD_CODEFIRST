...
namespace CRUD_CDFIRST.DAL
{
    public class SchoolInitializer: System.Data.Entity. DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            ...
            {
            new Student{FirstName="Manan",LastName="Patel",EnrollmentDate=DateTime.Parse("2005-09-01")},
            new Student{FirstName="Vraj",LastName="Shah",EnrollmentDate=DateTime.Parse("2002-09-01")},
            new Student{FirstName="Raju",LastName="Soni",EnrollmentDate=DateTime.Parse("2003-09-01")},
            };
